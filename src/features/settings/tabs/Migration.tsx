                ...
                <tbody className="divide-y divide-slate-200">
                  {previewData.animals.slice(0, 10).map((animal, idx) => (
                    <tr key={idx} className="bg-white">
                      ...
                      <td className="px-4 py-2 text-sm font-bold text-slate-700">{animal.name}</td>
                      <td className="px-4 py-2 text-xs text-slate-500">{animal.species}</td>
                      <td className="px-4 py-2 text-xs font-mono text-slate-500">{animal.logs?.length || 0}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
